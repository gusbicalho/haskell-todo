...
a specific type, only a 'Show' constraint. This would require us to add
...
Code that uses it is just as generic - it can just require that a 'Hasher'
exist for some monadic context and input type.
-}
